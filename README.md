...
```bash
python experiments/launch_nodes.py --robot ur --robot_ip 192.168.12.111
```
...
在终端输入：
```bash
python experiments/run_env.py --agent=gello --use-save-interface --task-name "Slide the roll of tape over the cylindrical tea box"
```
